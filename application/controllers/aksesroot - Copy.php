...
class Aksesroot extends CI_Controller {
	...
	function index()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				$data["judul"] = "Dashboard - BitCom Online Jember";
    ...
    function top_no_html()
	{
		...
		if($session!=""){
			...
			{
				$data["judul"] = "Dashboard - BitCom Online Jember";
				$this->load->view('admin/bg_top_no_html_head.php',$data);
			}
		}		
	}
    function bottom_no_html()
	{
		$session=isset($_SESSION['admin_grosir_sandal']) ? $_SESSION['admin_grosir_sandal']:'';
		if($session!=""){
			$pecah=explode("|",$session);
	...
	function set_akun()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				$data["judul"] = "Pengaturan Akun Admin - BitCom Online Jember";
	...
	function set_banner()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["judul"] = "Pengaturan Banner - BitCom Online Jember";
	...
	function tambah_admin()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				$data["judul"] = "Tambah Admin - BitCom Online Jember";
	...
	function lihat_semua_member()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["judul"] = "Semua Member - BitCom Online Jember";
	...
	function lihat_semua_testimonial()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["judul"] = "Semua Testimonial - BitCom Online Jember";
	...
	function lihat_produk()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["judul"] = "Semua Produk - BitCom Online Jember";
	...
	function lihat_semua_intermezzo()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["judul"] = "Semua Intermezzo - BitCom Online Jember";
	...
	function transaksi_harian()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["judul"] = "Transaksi Harian - BitCom Online Jember";
	...
	function transaksi_bulanan()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["judul"] = "Transaksi Bulanan - BitCom Online Jember";
				$data["tampil"] = $this->sandal_admin_model->tampil_trans_harian($data['kata'],$limit,$offset);
				$tot_hal = $this->sandal_model->hitung_isi_1tabel('tbl_transaksi_detail',"where kode_transaksi like '%".$data['kata']."%'");
	...
	function transaksi_tahunan()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["judul"] = "Transaksi Tahunan - BitCom Online Jember";
				$data["tampil"] = $this->sandal_admin_model->tampil_trans_harian($data['kata'],$limit,$offset);
				$tot_hal = $this->sandal_model->hitung_isi_1tabel('tbl_transaksi_detail',"where kode_transaksi like '%".$data['kata']."%'");
	...
	function lihat_kategori_produk()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				$data["judul"] = "Semua Kategori Produk - BitCom Online Jember";
	...
	function lihat_katalog()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["judul"] = "Semua Katalog Produk - BitCom Online Jember";
...
//=======================Modul Tambah======================//
	...
	function tambah_produk()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["judul"] = "Tambah Produk - BitCom Online Jember";
				$this->load->view('admin/bg_top',$data);
	...
	function tambah_kategori_produk()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
	   			$data['scriptmce'] = $this->scripttiny_mce();
				$data["kat"] = $this->sandal_admin_model->tampil_semua_kategori();
				$data["judul"] = "Tambah Kategori Produk - BitCom Online Jember";
				$this->load->view('admin/bg_top',$data);
	...
	function tambah_katalog()
	{
		...
		if($session!=""){
			...
			{
	   			$data['scriptmce'] = $this->scripttiny_mce();
				$data["judul"] = "Tambah Katalog Produk - BitCom Online Jember";
				$this->load->view('admin/bg_top',$data);
	...
	function tambah_intermezzo()
	{
		...
		if($session!=""){
			...
			{
	   			$data['scriptmce'] = $this->scripttiny_mce();
				$data["judul"] = "Tambah Intermezzo - BitCom Online Jember";
				$this->load->view('admin/bg_top',$data);
	...
	function edit_banner()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["judul"] = "Edit Banner - BitCom Online Jember";
				$this->load->view('admin/bg_top',$data);
	...
	function edit_katalog()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["judul"] = "Edit Katalog - BitCom Online Jember";
				$this->load->view('admin/bg_top',$data);
	...
	function edit_member()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["judul"] = "Edit Member - BitCom Online Jember";
				$this->load->view('admin/bg_top',$data);
	...
	function edit_testi()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["judul"] = "Edit Testimonial - BitCom Online Jember";
				$this->load->view('admin/bg_top',$data);
	...
	function edit_intermezzo()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["judul"] = "Edit Intermezzo - BitCom Online Jember";
				$this->load->view('admin/bg_top',$data);
