...
class Member extends CI_Controller {
	...
	function index()
	{
		...
		if($session!=""){
			...
			$data['judul'] = "Member Area - BitCom Jember, Toko Komputer Termurah dan Terlengkap di Jember - BitCom Jember";
	...
	function login()
	{
		...
		if($session!=""){
			...
			$data['menu'] = $this->sandal_model->menu_kategori('0','0');
			$data['judul'] = "Log In Member - BitCom Jember, Toko Komputer Termurah dan Terlengkap di Jember - BitCom Jember";
			$data['slide_atas'] = $this->sandal_model->tampil_slide_produk(10);
			$data['slide_laris'] = $this->sandal_model->tampil_slide_produk_terlaris_kiri(5);
			$data['slide_baru'] = $this->sandal_model->tampil_produk(5);
			$data['slide_rekomendasi'] = $this->sandal_model->tampil_slide_produk(6);
	...
	function daftar()
	{
		...
		if($session!=""){
			...
			$data['menu'] = $this->sandal_model->menu_kategori('0','0');
			$data['judul'] = "Register Member - BitCom Jember, Toko Komputer Termurah dan Terlengkap di Jember - BitCom Jember";
			$data['slide_atas'] = $this->sandal_model->tampil_slide_produk(10);
			$data['slide_laris'] = $this->sandal_model->tampil_slide_produk_terlaris_kiri(5);
			$data['slide_baru'] = $this->sandal_model->tampil_produk(5);
			$data['slide_rekomendasi'] = $this->sandal_model->tampil_slide_produk(6);
		...
		if($session!=""){
			...
			else
			{
					...
					if (count($q->result())>0){
						...
						$this->email->subject('Aktivasi Keanggotaan - BitCom Online Jember');
	...
	function lupa()
	{
		...
		if($session==""){
			$data['menu'] = $this->sandal_model->menu_kategori('0','0');
			$data['judul'] = "Lupa Password - BitCom Jember, Toko Komputer Termurah dan Terlengkap di Jember - BitCom Jember";
			$data['slide_atas'] = $this->sandal_model->tampil_slide_produk(10);
			$data['slide_laris'] = $this->sandal_model->tampil_slide_produk_terlaris_kiri(5);
			$data['slide_baru'] = $this->sandal_model->tampil_produk(5);
			$data['slide_rekomendasi'] = $this->sandal_model->tampil_slide_produk(6);
	...
	function update_reset_pass()
	{
		...
		if($session!=""){
			...
			$data['menu'] = $this->sandal_model->menu_kategori('0','0');
			$data['judul'] = "Set Password - BitCom Jember, Toko Komputer Termurah dan Terlengkap di Jember - BitCom Jember";
			$data['slide_atas'] = $this->sandal_model->tampil_slide_produk(10);
			$data['slide_laris'] = $this->sandal_model->tampil_slide_produk_terlaris_kiri(5);
			$data['slide_baru'] = $this->sandal_model->tampil_produk(5);
			$data['slide_rekomendasi'] = $this->sandal_model->tampil_slide_produk(6);
	...
	function history()
	{
		...
		if($session==""){
			...
			$data["kd_user"]=$pecah[2];
			$data['menu'] = $this->sandal_model->menu_kategori('0','0');
			$data['judul'] = "History Transaksi - BitCom Jember, Toko Komputer Termurah dan Terlengkap di Jember - BitCom Jember";
			$data['slide_atas'] = $this->sandal_model->tampil_slide_produk(10);
			$data['slide_laris'] = $this->sandal_model->tampil_slide_produk_terlaris_kiri(5);
			$data['slide_baru'] = $this->sandal_model->tampil_produk(5);
			$data['slide_rekomendasi'] = $this->sandal_model->tampil_slide_produk(6);
